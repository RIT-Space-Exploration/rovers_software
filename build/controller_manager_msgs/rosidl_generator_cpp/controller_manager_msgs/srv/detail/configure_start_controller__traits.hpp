...
inline void to_yaml(
  const controller_manager_msgs::srv::ConfigureStartController_Request & msg,
...
inline std::string to_yaml(const controller_manager_msgs::srv::ConfigureStartController_Request & msg)
{
...
inline void to_yaml(
  const controller_manager_msgs::srv::ConfigureStartController_Response & msg,
  std::ostream & out, size_t indentation = 0)
{
  // member: ok
  {
...
inline std::string to_yaml(const controller_manager_msgs::srv::ConfigureStartController_Response & msg)
{
  std::ostringstream out;
  to_yaml(msg, out);
  return out.str();
